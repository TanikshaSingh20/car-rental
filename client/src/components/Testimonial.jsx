...
const Testimonial = () => {
  const testimonials = [
    ...
    },
    {
      ...
      image: assets.testimonial_image_1,
      testimonial:
        "I highly recommend CarRental! Their fleet is outstanding, and I always feel like I'm getting the best deal with excellent service.",
    },
  ];
  ...
  return (
    <div className="py-28 px-6 md:px-16 lg:px-24 xl:px-44">
      <Title
        ...
        subTitle="Discover why discerning travelers choose CarRental for their transportation needs."
      />
